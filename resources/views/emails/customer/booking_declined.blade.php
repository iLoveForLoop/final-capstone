...
<head>
    ...
    <title>Booking Declined - Eventory</title>
</head>
...
<body
    ...
    <div style="display: none; max-height: 0; overflow: hidden;">
        Your booking request for {{ $booking->service->name }} has been declined by
            ...
            <tr>
                <td>
                    ...
                    <p style="font-size: 15px; color: #475569; margin: 0 0 32px 0; line-height: 1.7;">
                        ...
                        has been declined. While we understand this may be disappointing, there are many other qualified
                        vendors ready to help make your event special.
                    </p>
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 8px 0;">
                                            <span
                                                style="background: #fef3c7; color: #d97706; padding: 6px 14px; border-radius: 16px; font-size: 12px; font-weight: 600; display: inline-block;">Declined</span>
                                        </td>
                                    </tr>
                                    @if ($declineReason)
                                        <tr>
                                    ...
                                    <tr>
                                        <td style="padding-left: 12px;">
                                            <p
                                                ...
                                                Don't Worry - Find Another Vendor</p>
                                            <p style="color: #0c4a6e; font-size: 13px; margin: 0; line-height: 1.5;">
                                                Vendors may decline bookings due to various reasons including prior
                                                commitments,
                                                date unavailability, or specific service requirements. We have many
                                                other excellent
                        ...
                        <tr>
                            <td align="center">
                                <a href="{{ route('client.service.index') }}"
                                    style="display: inline-block; padding: 12px 24px; background: #f59e0b; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 14px; margin: 0 8px; transition: all 0.2s;">
                        ...
                        <tr>
                            <td>
                                ...
                                <ul
                                    ...
                                    <li style="margin-bottom: 8px;">Browse similar services for your preferred date</li>
                                    <li style="margin-bottom: 8px;">Consider adjusting your event date for more options
                                    </li>
                                    <li style="margin-bottom: 8px;">Contact vendors directly to check availability
                                        before booking</li>
                                    <li>Use our advanced filters to find vendors with instant confirmation</li>
                                </ul>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            <td>
                                <h4 style="color: #1e293b; font-size: 15px; font-weight: 600; margin: 0 0 12px 0;">
                                    Need Help Finding Alternatives?</h4>
                                <p style="color: #475569; font-size: 14px; margin: 0 0 8px 0;">
                                    Our team can help you find vendors with confirmed availability for your event date.
                                    We'll match you with professionals who specialize in services similar to what you're
                                    looking for.
                                </p>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                <h4 style="color: #065f46; font-size: 15px; font-weight: 600; margin: 0 0 8px 0;">
                                    Tips for Successful Booking</h4>
                                <p style="color: #047857; font-size: 14px; margin: 0;">
                                    • Book well in advance for popular dates<br>
                                    • Provide detailed event requirements<br>
                                    • Consider vendors with "Instant Confirm" badge<br>
                                    • Have flexible dates for more options
                                </p>
                            </td>
                        </tr>
                    </table> -->
                    ...
                    <!-- Closing -->
                    <p style="font-size: 15px; color: #475569; margin: 0 0 8px 0;">We're here to help you find the
                        perfect vendor for your event. Don't let this setback discourage you - many wonderful vendors
                        are available!</p>
        ...
        <table width="100%" cellpadding="0" cellspacing="0"
            ...
            <tr>
                <td style="padding: 20px 30px;">
                    <p style="color: #64748b; font-size: 13px; margin: 0 0 8px 0; font-weight: 500;">Need Help Finding
                        a Vendor?</p>
                    <p style="color: #475569; font-size: 13px; margin: 0 0 12px 0;">
                        Our customer support team can help you find alternative vendors or provide personalized
                        recommendations based on your event needs.
                    </p>
                    <a href="mailto:support@eventory.com"
                        style="color: #f59e0b; text-decoration: none; font-size: 13px; font-weight: 500;">Get
