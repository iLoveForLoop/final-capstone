            ...
            <tr>
                <td>
                    ...
                    <p style="font-size: 15px; color: #475569; margin: 0 0 32px 0; line-height: 1.7;">
                        We're writing to inform you that your booking request with
                        <strong>{{ $booking->service->vendor->business_name }}</strong>
                        has been declined. While this may be disappointing, we're here to help you find the perfect
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 8px 0;">
                                            <span
                                                style="background: #fecaca; color: #dc2626; padding: 6px 14px; border-radius: 16px; font-size: 12px; font-weight: 600; display: inline-block;">Declined</span>
                                        </td>
                                    </tr>
                                    @if ($declineReason)
                                        <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-left: 12px;">
                                            ...
                                            <p style="color: #0c4a6e; font-size: 13px; margin: 0; line-height: 1.5;">
                                                No payment was processed for this booking request, so no refund is
                                                needed.
                                                Your payment method was never charged for this declined booking.
                                            </p>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <tr>
                            <td>
                                ...
                                <ul
                                    ...
                                    <li style="margin-bottom: 8px;">Browse similar services available for your preferred
                                        date</li>
                                    <li style="margin-bottom: 8px;">Consider adjusting your event date or requirements
                                        for better availability</li>
                                    <li style="margin-bottom: 8px;">Contact our support team for personalized vendor
                                        recommendations</li>
                                    <li>Save your favorite vendors for faster booking in the future</li>
                                </ul>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            <td>
                                <h4 style="color: #1e293b; font-size: 15px; font-weight: 600; margin: 0 0 12px 0;">
                                    Looking for Similar Services?</h4>
                                <p style="color: #475569; font-size: 14px; margin: 0 0 8px 0;">
                                    We have many qualified vendors offering similar services. Our matching system can
                                    help you find the perfect fit based on your event requirements and budget.
                                </p>
                            </td>
                        </tr>
                    </table>
                    ...
                    <p style="font-size: 15px; color: #475569; margin: 0 0 8px 0;">We're here to help you find the
                        perfect vendor for your special occasion.</p>
        ...
        <table width="100%" cellpadding="0" cellspacing="0"
            ...
            <tr>
                <td style="padding: 20px 30px;">
                    <p style="color: #64748b; font-size: 13px; margin: 0 0 8px 0; font-weight: 500;">Need Help Finding a
                        Vendor?</p>
                    <p style="color: #475569; font-size: 13px; margin: 0 0 12px 0;">
                        Our customer support team can provide personalized vendor recommendations based on your specific
