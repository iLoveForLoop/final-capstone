...
<template>
    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-white to-teal-50 relative overflow-hidden">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3">
                            ...
                            <div class="flex-1 relative">
                                <Search class="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400"
                                    :size="20" />
                                <input v-model="search" type="text" placeholder="What service are you looking for?"
        ...
        <section id="how-it-works" class="py-16 bg-gray-50 relative z-10">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 class="text-3xl font-bold text-center text-gray-900 mb-16 reveal-animation">How Eventory Works</h2>
        ...
        <section class="py-16 relative z-10">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <p class="text-gray-600 text-sm leading-relaxed">Find the perfect food and beverage providers for
                        your event</p>
                    </Link>
                    ...
                    <h3
                        class="text-xl font-semibold text-gray-900 mb-3 group-hover:text-blue-600 transition-colors duration-300">
                        Photography</h3>
                    <p class="text-gray-600 text-sm leading-relaxed">Professional photographers and photo booth services
                    </p>
                    </Link>
                    ...
                    <h3
                        class="text-xl font-semibold text-gray-900 mb-3 group-hover:text-blue-600 transition-colors duration-300">
                        Sound Systems</h3>
                    <p class="text-gray-600 text-sm leading-relaxed">Audio equipment and technical support for events
                    </p>
                    </Link>
                    ...
                    <h3
                        class="text-xl font-semibold text-gray-900 mb-3 group-hover:text-blue-600 transition-colors duration-300">
                        Entertainers</h3>
                    <p class="text-gray-600 text-sm leading-relaxed">Bands, DJs, performers, and other entertainment</p>
                    </Link>
                    ...
                    <h3
                        class="text-xl font-semibold text-gray-900 mb-3 group-hover:text-blue-600 transition-colors duration-300">
                        Makeup Artists</h3>
                    <p class="text-gray-600 text-sm leading-relaxed">Professional beauty services for special occasions
                    </p>
                    </Link>
                    ...
                    <h3
                        class="text-xl font-semibold text-gray-900 mb-3 group-hover:text-blue-600 transition-colors duration-300">
                        Attire Rentals</h3>
                    <p class="text-gray-600 text-sm leading-relaxed">Formal wear and costume rentals for your event</p>
                    </Link>
                </div>
            </div>
        </section>
                ...
                <div class="grid md:grid-cols-4 gap-10">
                    ...
                    <div class="reveal-animation animation-delay-100">
                        ...
                        <ul class="space-y-3 text-sm">
                            ...
                            <li>
                                <Link href="/pricing"
                                    class="text-gray-400 hover:text-white transition-colors duration-300">Pricing</Link>
                            </li>
                            <li>
                                <Link href="/services"
                                    class="text-gray-400 hover:text-white transition-colors duration-300">Vendors</Link>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="reveal-animation animation-delay-200">
                        ...
                        <ul class="space-y-3 text-sm">
                            ...
                            <li>
                                <Link href="/careers"
                                    class="text-gray-400 hover:text-white transition-colors duration-300">Careers</Link>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="reveal-animation animation-delay-300">
                        ...
                        <ul class="space-y-3 text-sm">
                            ...
                            <li>
                                <Link href="/terms"
                                    class="text-gray-400 hover:text-white transition-colors duration-300">Terms</Link>
                            </li>
                            <li>
                                <Link href="/cookie-policy"
                                    class="text-gray-400 hover:text-white transition-colors duration-300">Cookie Policy
                                </Link>
                            </li>
                        </ul>
                    </div>
