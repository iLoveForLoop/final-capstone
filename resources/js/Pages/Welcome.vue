<template>
    ...
    <ClientLayout>
        <div class="min-h-screen bg-gradient-to-br from-gray-300 via-white to-gray-500  relative overflow-hidden">
            <!-- Enhanced animated background with event collage -->
            <div class="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
                <!-- Moving collage of event service pictures -->
                ...
                <!-- Keep the original gradient blobs but reduce opacity -->
                <div
                    class="absolute -top-40 -right-32 w-80 h-80 bg-blue-600 rounded-full mix-blend-multiply filter blur-xl opacity-10 animate-blob animation-delay-2000">
                </div>
                <div
                    class="absolute top-60 -left-20 w-80 h-80 bg-purple-600 rounded-full mix-blend-multiply filter blur-xl opacity-10 animate-blob animation-delay-4000">
                </div>
                <div
                    class="absolute -bottom-20 left-40 w-80 h-80 bg-teal-600 rounded-full mix-blend-multiply filter blur-xl opacity-10 animate-blob">
                </div>
            </div>
            ...
            <section class="relative z-10">
                <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
                    <div class="flex flex-col lg:flex-row items-center gap-12">
                        <!-- Left Content -->
                        <div class="lg:w-1/2 text-center lg:text-left reveal-animation">
                            ...
                            <p class="text-lg md:text-xl text-gray-600 mb-8 max-w-2xl leading-relaxed">
                                ...
                                Thousands of vendors ready to make your event unforgettable.
                            </p>
                            ...
                            <div class="flex flex-wrap gap-6 mb-8 justify-center lg:justify-start">
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="text-sm text-gray-600">Events Planned</div>
                                </div>
                                <div class="text-center">
                            ...
                            <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                                <button @click="loginModal.show()"
                                    class="inline-flex items-center justify-center px-6 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-all duration-300 font-medium shadow-md hover:shadow-lg reveal-animation animation-delay-400">
                                    <Calendar class="h-5 w-5 mr-2" />
                                    Start Planning Now
                                </button>
                                <button
                                    class="inline-flex items-center justify-center px-6 py-3 bg-white text-gray-700 border border-gray-300 rounded-xl hover:bg-gray-50 transition-all duration-300 font-medium shadow-sm hover:shadow-md">
                        ...
                        <div class="lg:w-1/2 w-full max-w-lg reveal-animation animation-delay-200">
                            <div
                                class="bg-white/90 backdrop-blur-md border border-gray-200/60 rounded-2xl p-6 shadow-xl">
                                <h3 class="text-xl font-bold text-gray-900 mb-4 text-center">Find Your Perfect Service
                                </h3>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="flex gap-3">
                                        ...
                                        <button @click="showFiltersDialog = true"
                                            class="relative flex-1 flex items-center justify-center gap-2 px-4 py-3 text-sm font-medium text-gray-700 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 hover:border-gray-300 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 transition-all duration-300 shadow-sm hover:shadow-md">
                                            <Sliders :size="18" />
                                            <span>Filters</span>
                                        ...
                                        <button @click="handleSearch"
                                            class="flex-1 px-4 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-all duration-300 font-medium shadow-md hover:shadow-lg">
                                            Search
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div class="mt-6 pt-6 border-t border-gray-200">
                                    <!-- <p class="text-xs text-gray-500 text-center mb-3">Trusted by event planners
                                        worldwide</p> -->
                                    <div class="flex justify-center items-center space-x-4 opacity-60">
                                        <div class="text-xs text-gray-600">✓ Secure Booking</div>
                                        <div class="text-xs text-gray-600">✓ Verified Vendors</div>
                                        <div class="text-xs text-gray-600">✓ 24/7 Support</div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section id="how-it-works" class="py-16 bg-gray-50 relative z-10">
                <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 class="text-3xl font-bold text-center text-gray-900 mb-16 reveal-animation">How Eventory Works
                    </h2>
            ...
            <section class="py-16 relative z-10">
                <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <p class="text-gray-600 text-sm leading-relaxed">Find the perfect food and beverage providers
                            for
                            your event</p>
                        </Link>
                        ...
                        <h3
                            class="text-xl font-semibold text-gray-900 mb-3 group-hover:text-blue-600 transition-colors duration-300">
                            Entertainers</h3>
                        <p class="text-gray-600 text-sm leading-relaxed">Bands, DJs, performers, and other entertainment
                        </p>
                        </Link>
                        ...
                        <h3
                            class="text-xl font-semibold text-gray-900 mb-3 group-hover:text-blue-600 transition-colors duration-300">
                            Attire Rentals</h3>
                        <p class="text-gray-600 text-sm leading-relaxed">Formal wear and costume rentals for your event
                        </p>
                        </Link>
                    </div>
                </div>
            ...
            <section class="py-16 bg-blue-600 text-white relative z-10">
                <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <div class="flex flex-col sm:flex-row justify-center gap-4 reveal-animation animation-delay-200">
                    ...
                    <div class="grid md:grid-cols-4 gap-10">
                        <div class="reveal-animation">
                            ...
                            <p class="text-gray-400 text-sm leading-relaxed">
                                The centralized platform for event planners and local vendors to connect, collaborate,
                                and
                        ...
                        <div class="reveal-animation animation-delay-100">
                            ...
                            <ul class="space-y-3 text-sm">
                                <li>
                                    <Link href="/features"
                                        class="text-gray-400 hover:text-white transition-colors duration-300">Features
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/pricing"
                                        class="text-gray-400 hover:text-white transition-colors duration-300">Pricing
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/services"
                                        class="text-gray-400 hover:text-white transition-colors duration-300">Vendors
                                    </Link>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="reveal-animation animation-delay-200">
                            ...
                            <ul class="space-y-3 text-sm">
                                ...
                                <li>
                                    <Link href="/careers"
                                        class="text-gray-400 hover:text-white transition-colors duration-300">Careers
                                    </Link>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="reveal-animation animation-delay-300">
                            ...
                            <ul class="space-y-3 text-sm">
                                <li>
                                    <Link href="/privacy"
                                        class="text-gray-400 hover:text-white transition-colors duration-300">Privacy
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/terms"
...
const backgroundImages = ref([
    { url: 'https://images.unsplash.com/photo-1511795409834-ef04bbd61622?w=300&h=200&fit=crop', delay: 0, position: { x: 5, y: 10 } },
    { url: 'https://images.unsplash.com/photo-1532634922-8fe0b757fb13?w=300&h=200&fit=crop', delay: 2, position: { x: 15, y: 25 } },
    { url: 'https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?w=300&h=200&fit=crop', delay: 4, position: { x: 25, y: 5 } },
    { url: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300&h=200&fit=crop', delay: 1, position: { x: 35, y: 35 } },
    { url: 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=300&h=200&fit=crop', delay: 3, position: { x: 45, y: 15 } },
    { url: 'https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=300&h=200&fit=crop', delay: 5, position: { x: 55, y: 30 } },
    { url: 'https://images.unsplash.com/photo-1511795409834-ef04bbd61622?w=300&h=200&fit=crop', delay: 2, position: { x: 65, y: 8 } },
    { url: 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=300&h=200&fit=crop', delay: 4, position: { x: 75, y: 22 } },
    { url: 'https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=300&h=200&fit=crop', delay: 1, position: { x: 85, y: 12 } }
]);

// Quick categories for the hero section
