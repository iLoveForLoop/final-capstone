                ...
                <div class="flex flex-col md:flex-row gap-4">
                    ...
                    <div class="flex items-end">
                        <button @click="resetFilters"
                            class="px-4 py-2 text-xs text-indigo-600 hover:text-indigo-800 hover:bg-indigo-50 rounded-lg flex items-center gap-1 h-[36px] transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end gap-2">
                                        <button @click="viewReport(report)"
                                            class="px-3 py-1.5 text-xs bg-blue-50 text-blue-700 hover:bg-blue-100 rounded-md flex items-center gap-1 transition-colors">
                                        ...
                                        <button @click="updateStatus(report.id, 'reviewed')"
                                            ...
                                            class="px-3 py-1.5 text-xs bg-yellow-50 text-yellow-700 hover:bg-yellow-100 rounded-md flex items-center gap-1 transition-colors">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5"
                                                viewBox="0 0 20 20" fill="currentColor">
                                                <path fill-rule="evenodd"
                                        ...
                                        <button @click="updateStatus(report.id, 'resolved')"
                                            ...
                                            class="px-3 py-1.5 text-xs bg-green-50 text-green-700 hover:bg-green-100 rounded-md flex items-center gap-1 transition-colors">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5"
                                                viewBox="0 0 20 20" fill="currentColor">
                                                <path fill-rule="evenodd"
                                        ...
                                        <button @click="updateStatus(report.id, 'dismissed')"
                                            ...
                                            class="px-3 py-1.5 text-xs bg-red-50 text-red-700 hover:bg-red-100 rounded-md flex items-center gap-1 transition-colors">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5"
                                                viewBox="0 0 20 20" fill="currentColor">
                                                <path fill-rule="evenodd"
            ...
            <div class="bg-white rounded-lg max-w-2xl w-full p-6 max-h-[90vh] overflow-y-auto">
                ...
                <div v-if="selectedReport" class="space-y-4">
                    ...
                    <div class="flex flex-wrap justify-end gap-3 pt-4 border-t border-gray-200">
                        <button @click="showModal = false"
                            class="px-4 py-2 text-sm text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M6 18L18 6M6 6l12 12" />
                        ...
                        <button v-if="selectedReport.status === 'reviewed'"
                            ...
                            class="px-4 py-2 text-sm text-white bg-green-600 rounded-lg hover:bg-green-700 transition-colors flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20"
                                fill="currentColor">
                                <path fill-rule="evenodd"
                                    d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z"
