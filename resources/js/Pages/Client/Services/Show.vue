...
//     const link = route('client.service.show', props.service.id) // e.g. /client/services/12
                        ...
                        <div class="flex items-start justify-between mb-6">
                            ...
                            <div class="flex space-x-2">
                                <button @click="copyLink"
                                    class="p-2 border border-gray-300 rounded-lg hover:bg-blue-200 transition-colors">
                                    <Link2 class="w-5 h-5" />
                                </button>
                                <button @click="toggleFavorite()"
                                    class="p-2 border border-gray-300 rounded-lg  transition-colors"
                                    :class="{ 'bg-red-100': service.is_favorite }">

                                    <Heart class="w-5 h-5 sm:w-5 sm:h-5"
                                        :class="service.is_favorite ? 'text-red-600 fill-current' : ''" />
                                </button>
                        ...
                        <div v-show="activeTab === 'overview'">
                            <div class="prose max-w-none">
                                ...
                                <div v-if="service.specifications.length > 0">
                                    <h4 class="text-xl font-semibold mb-3">What's Included:</h4>
