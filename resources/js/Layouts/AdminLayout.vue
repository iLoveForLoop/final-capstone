    ...
    <div class="h-screen bg-blue-800 dark:bg-gray-900 flex flex-col">
        ...
        <main class="h-full overflow-hidden bg-blue-200 flex relative">
            ...
            <Transition enter-active-class="transition-transform duration-300 ease-out"
                ...
                leave-active-class="transition-transform duration-100 ease-in" leave-from-class="translate-x-0"
                leave-to-class="-translate-x-full">
                <Sidebar v-if="showingSidebar" class="absolute left-0 top-0 z-10" />
            </Transition>

            <!-- Main content with animated margin -->
            <div class="flex-1 transition-all duration-300 ease-out"
                :class="{ 'ml-52': showingSidebar, 'ml-0': !showingSidebar }">
                <nav class="border-b border-gray-100 blue-grey-darken-4 dark:border-gray-700 dark:bg-gray-800">
                    <!-- Primary Navigation Menu -->
                    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <button @click="showingSidebar = !showingSidebar">Toggle Me</button>
