            ...
            <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
                ...
                <div class="p-8">
                    ...
                    <div class="flex justify-center mb-6">
                        <span class="text-3xl font-bold text-purple-800">Eventory</span>
                    </div>

                    <!-- Status Message -->
                    <div v-if="status" class="mb-6 p-3 bg-green-100 text-green-700 rounded-lg text-sm">
                        {{ status }}
                    </div>

                    <h2 class="text-2xl font-bold text-center text-gray-900 mb-6">Welcome Back</h2>
                    <p class="text-gray-600 text-center mb-8">Log in to manage your events and bookings</p>
                    ...
                    <form @submit.prevent="submit" class="space-y-5">
                        ...
                        <!-- Submit Button -->
                        <button type="submit"
                            class="w-full py-3 px-4 bg-purple-600 hover:bg-purple-700 text-white font-medium rounded-lg transition focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
                    ...
                    <div class="mt-8">
                        ...
                        <div class="mt-6 grid grid-cols-2 gap-3">
                            <button type="button"
                                class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500">
