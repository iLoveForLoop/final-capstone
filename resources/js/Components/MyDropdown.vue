        ...
        <Transition enter-active-class="transition ease-out duration-100"
            ...
            <div v-if="isDropdownShowing"
                ...
                <div class="py-1">
                    ...
                    <Link v-if="$page.props.auth.user.roles[0].name === 'client'" :href="route('client.profile.index')"
                    ...
                    <Link v-if="$page.props.auth.user.roles[0].name === 'vendor'" :href="route('vendor.account.index')"
                        class="flex items-center px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors duration-150">
                    <svg class="w-4 h-4 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                    ...
                    <Link v-if="$page.props.auth.user.roles[0].name === 'admin'" :href="route('admin.account.index')"
                        class="flex items-center px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors duration-150">
                    <svg class="w-4 h-4 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                            d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
