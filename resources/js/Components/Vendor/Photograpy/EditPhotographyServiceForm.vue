...
import {
    ...
    Camera, Tag, FileText, CheckCircle,
    Settings, Circle, Loader, Edit3
...
const form = useForm({
    ...
    cover_images: [],
    notes: props.service.photography_service?.notes || '',

    // Photography specific fields
    studio_shoot_available: props.service.photography_service?.studio_shoot_available || false,
    specifications: props.service.photography_service?.specifications || [],
...
const submit = () => {
    form.post(route('vendor.photography-services.update', props.service.id), {
        preserveScroll: true,
        onSuccess: () => {
