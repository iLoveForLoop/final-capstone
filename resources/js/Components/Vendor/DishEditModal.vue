...
const submit = () => {
    form.post(route('vendor.dishes.update', currentDish.value.id), {
        preserveScroll: true,
        onSuccess: () => {
...
const showModal = (dish) => {
    ...
    form.dietary_type = dish.dietary_type;
    form.course_type = dish.course_type;
    form.is_available = dish.is_available == 1 ? true : false;
    selected_img.value = dish.image_url;
    show.value = true;
};
                        ...
                        <div class="px-4 sm:px-6">
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center">
                                    ...
                                    {{ console.log('Available: ', form.is_available) }}
