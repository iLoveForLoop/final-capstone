...
import { Eye, X, Image as ImageIcon, Star, CheckCircle } from 'lucide-vue-next';
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div class="space-y-6">
                                ...
                                <div v-if="service.specifications && service.specifications.length > 0"
                                    ...
                                    <h4 class="text-lg font-semibold text-gray-900 mb-4">Service Specifications</h4>
                                    <div class="flex flex-wrap gap-2">
                                        <span v-for="(spec, index) in service.specifications" :key="index"
                                ...
                                <!-- Additional Notes -->
                                <div v-if="service.notes" class="bg-white border border-gray-200 rounded-xl p-6">
                                    <h4 class="text-lg font-semibold text-gray-900 mb-4">Additional Notes</h4>
                                    <p class="text-gray-600 leading-relaxed whitespace-pre-line">{{ service.notes }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
