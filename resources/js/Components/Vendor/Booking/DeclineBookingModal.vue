...
const declineReason = defineModel('declineReason')

const emit = defineEmits(['close-modals', 'decline-booking', 'cancel'])
</script>
                    ...
                    <div v-if="showDeclineModal"
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center space-x-3">
                                <div class="flex items-center justify-center w-10 h-10 bg-orange-100 rounded-lg">
                                    <X class="w-5 h-5 text-orange-600" />
                                </div>
                                <div>
                        ...
                        <div class="p-4 mb-4 bg-orange-50 border border-orange-200 rounded-lg">
                            <div class="flex space-x-3">
                                ...
                                <div class="flex-1">
                                    <h4 class="text-sm font-medium text-orange-900">Please confirm your decision</h4>
                                    <p class="mt-1 text-xs text-orange-700">
                                        The client will be notified that you're unable to accept this booking. This
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="declineReason" v-model="declineReason" rows="3"
                                placeholder="Let the client know why you're unable to accept this booking..."
                                class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 resize-none"></textarea>
                            <p class="mt-1 text-xs text-gray-500">This helps clients understand your availability and
                                maintains good relationships.</p>
                        </div>
                        ...
                        <div class="flex space-x-3">
                            ...
                            <button @click="emit('decline-booking')"
                                :disabled="isLoading(selectedBooking?.raw_id, 'declining')"
                                class="flex-1 px-4 py-2.5 text-sm font-medium text-white bg-orange-600 border border-transparent rounded-lg hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors">
                                <div v-if="isLoading(selectedBooking?.raw_id, 'declining')"
