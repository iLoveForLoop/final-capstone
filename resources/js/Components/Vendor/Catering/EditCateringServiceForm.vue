...
const submit = () => {
    ...
    console.log('deleted_images:', form.deleted_images);
...
<template>
    ...
    <div class="px-6 py-4">
        <div class="space-y-6">
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <button type="button"
                                                ...
                                                class="p-2 bg-white rounded-full transition-colors"
                        ...
                        <!-- Image Upload Area -->
                        <div class="mb-4" v-if="getTotalImageCount() < 5">
                        ...
                        <div v-if="selectedImages.length > 0" class="mb-4">
                            <h5 class="text-sm font-medium text-gray-700 mb-2">New Images to Add</h5>
            ...
            <div class="border-b border-gray-200 pb-6">
                <!-- Customizable -->
                {{ console.log('is customizeable: ', form.is_customizable) }}
                <div class="mb-6">
