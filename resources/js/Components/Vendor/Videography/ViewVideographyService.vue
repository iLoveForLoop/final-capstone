...
import { Eye, X, Image as ImageIcon, MapPin, Calendar, Users, Clock, Star, CheckCircle, Video } from 'lucide-vue-next';
            ...
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div
                    ...
                    <div class="bg-white px-6 py-4 border-b border-gray-200 sticky top-0 bg-white z-10">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                <div class="flex items-center space-x-2">
                                    <Video class="w-6 h-6 text-indigo-600" />
                        ...
                        <p class="text-sm text-gray-500 mt-1">Complete overview of your videography service listing</p>
                    </div>
                    ...
                    <div class="px-6 py-6">
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div class="space-y-6">
                                ...
                                <!-- Videography Specific Details -->
                                <div v-if="service.category?.name === 'Videography' && service.videography_service"
                                    class="bg-white border border-gray-200 rounded-xl p-6">
                                    <h4 class="text-lg font-semibold text-gray-900 mb-4">Videography Details</h4>
                                    <div class="space-y-4">
                                        <!-- Studio Shoot Availability -->
                                        <div class="flex items-center justify-between">
                                            <span class="text-sm text-gray-600">Studio Shoot</span>
                                            <div class="flex items-center space-x-1">
                                                <CheckCircle class="w-4 h-4"
                                                    :class="service.videography_service.studio_shoot_available ? 'text-green-500' : 'text-gray-400'" />
                                                <span class="font-medium"
                                                    :class="service.videography_service.studio_shoot_available ? 'text-green-700' : 'text-gray-500'">
                                                    {{ service.videography_service.studio_shoot_available ? 'Available'
                                                        :
                                                        'Not Available' }}
                                                </span>
                                            </div>
                                        ...
                                        <!-- Hours of Coverage -->
                                        <div class="flex items-center justify-between">
                                            <span class="text-sm text-gray-600">Hours of Coverage</span>
                                            <span class="font-medium text-gray-900">
                                                {{ service.videography_service.hours_of_coverage || 8 }} hours
                                            </span>
                                        </div>

                                        <!-- Number of Videographers -->
                                        <div class="flex items-center justify-between">
                                            <span class="text-sm text-gray-600">Videographers</span>
                                            <span class="font-medium text-gray-900">
                                                {{ service.videography_service.number_of_videographers || 1 }}
                                            </span>
                                        </div>
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            <span class="font-medium text-gray-900">
                                                {{ service.videography_service.delivery_time_days || 30 }} days
                                            </span>
                                        </div>

                                        <!-- Specifications -->
                                        <div
                                            v-if="service.videography_service.specifications && service.videography_service.specifications.length > 0">
                                            <span class="text-sm text-gray-600 block mb-2">Specifications:</span>
                                            <div class="flex flex-wrap gap-2">
                                                <span
                                                    v-for="(spec, index) in service.videography_service.specifications"
                                                    :key="index"
                                        ...
                                        <!-- Additional Notes -->
                                        <div v-if="service.videography_service.notes">
                                            <span class="text-sm text-gray-600 block mb-1">Additional Notes:</span>
                                            <p class="text-sm text-gray-700 whitespace-pre-line">{{
                                                service.videography_service.notes }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
