...
defineProps({
    ...
    minimumGuestRequirementMet: Boolean
})
...
<template>
    ...
    <div v-if="service?.category_name === 'Catering'">
        ...
        <input id="pax" v-model="form.pax" type="number" min="1" required
            ...
            :class="{ 'border-red-500': !minimumGuestRequirementMet }" placeholder="Enter the number of guests" />
        <div v-if="!minimumGuestRequirementMet" class="mt-2 text-sm text-red-600 flex items-center">
            <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd"
                    d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z"
                    clip-rule="evenodd" />
            </svg>
            {{ console.log('MG', service.minimumGuests)
            }}
            Minimum guest for this service is {{ service.minimumGuests }}.
        </div>
    </div>
