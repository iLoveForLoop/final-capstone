                                            ...
                                            <div v-for="(dishes, category) in service.catering_service.dishes"
                                                ...
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center gap-3">
                                                        <h4 class="text-base font-medium text-gray-900">{{ category }}
                                                        </h4>
                                ...
                                <div v-if="currentStep === 2" key="step2" class="space-y-6">
                                    ...
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        ...
                                        <div class="space-y-2 text-sm">
                                            ...
                                            <div v-if="form.description" class="flex justify-between">
                                                ...
                                                <span class="font-medium text-right max-w-xs">{{ form.description
                                                }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bg-amber-50 border border-amber-200 rounded-lg p-4">
                                        ...
                                        <p class="text-xs text-amber-700">
                                            ...
                                            upon acceptance of your request. Payment details and final confirmation will
                                            be
